...
export const projects = [
  ...
  },
 {
  ...
  {
    id: 7,
    title: "Pizza Hub - Online Pizza Ordering Platform",
    description: "Modern pizza ordering website with real-time menu, shopping cart, user authentication, order tracking, and secure payment integration. Designed for a seamless food delivery experience.",
    image: "/images/PizzaHub.png",
    technologies: ["React", "Vite", "Tailwind CSS", "Node.js", "MongoDB", "Stripe"],
    liveUrl: "https://pizza-hub-hazel.vercel.app/",
    githubUrl: "https://github.com/Muhammadkashifsaeed/pizza-hub",
    featured: true
  },
  {
    id: 8,
    title: "Digital Clock - Real-Time Modern Clock App",
    description: "A sleek, real-time digital clock application with live time, date, and optional 12/24 hour format toggle. Built with modern UI, smooth animations, and responsive design for all devices.",
    image: "/images/DigitalClock.png",
    technologies: ["React", "Vite", "Tailwind CSS"],
    liveUrl: "https://digital-clocks-rho.vercel.app/",
    githubUrl: "https://github.com/Muhammadkashifsaeed/digital-clocks",
    featured: true
  },
  {
    id: 9,
    title: "Social Media Dashboard - Modern Analytics & Feed",
    description: "A comprehensive social media dashboard with user feed, stories, posts, notifications, messages, and profile management. Includes dark mode, real-time updates, and responsive design for all devices.",
    image: "/images/SocialMediaDashboard.png",
    technologies: ["React", "Vite", "Tailwind CSS", "React Router", "Chart.js"],
    liveUrl: "https://social-media-dashbord-rosy.vercel.app/",
    githubUrl: "https://github.com/Muhammadkashifsaeed/social-media-dashbord",
    featured: true
  }
];
